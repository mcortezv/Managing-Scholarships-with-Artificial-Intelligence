...
public class DetallesActividadBaja extends PanelActividades{
    ...
    public void cargarInscripcion(InscripcionDTO inscripcion) {
      ...
      //  panelContenido.add(crearCampo("Unidad", inscripcion.get
     //   panelContenido.add(Box.createVerticalStrut(20));
       // panelContenido.add(crearCampo("Responsable de la Actividad ", "$" + inscripcion.get
        panelContenido.add(Box.createVerticalStrut(20));
    //    panelContenido.add(crearCampo("Lugar ", "$" + grupoDTO.getCosto()));
        panelContenido.add(Box.createVerticalStrut(20));
    //    panelContenido.add(crearCampo("Horario ", "$" + grupoDTO.getCosto()));
        panelContenido.add(Box.createVerticalGlue());
