 ...
 */
public class ListaInscripciones extends PanelActividades{
    JPanel panelContenido;
    EstudianteDTO estudianteRecuperado;

    public ListaInscripciones(ActividadesExtracurriculares actividadesExtracurriculares, CoordinadorAplicacionActividades coordinadorAplicacionActividades) {
     ...
     //   InscripcionesDTO inscripcionesDTO= coordinadorAplicacionActividades.obtenerInscripciones(estudianteRecuperado);
        ...
        for(InscripcionDTO inscripcion:inscripcionesDTO.getInscripciones()){
            ...
            boton.addActionListener(e->{
                 ...
                 System.out.println("fecha en pantalla lista inscripciones"+inscripcion.getFechaInscripcion());
