...
public class CoordinadorNegocio implements ICoordinadorNegocio {
     ...
     *
     * @param fachadaEvaluarSolicitudes  the fachada evaluar solicitudes
     * @param fachadaModificarResolucion the fachada modificar resolucion
     */
    ...
    public ResolucionDTO buscarResolucion(String tipoFiltro, String filtro) {
        try {
            ...
            if (resolucion == null) {
                throw new RuntimeException("No se encontró resolución con los criterios especificados");
            }
            return resolucion;
        } catch (Exception ex) {
    ...
    public ResolucionDTO reevaluarAutomatica(SolicitudDTO solicitud) {
        try {
            ...
            ResolucionDTO resolucion = fachadaModificarResolucion.resolverAutomatico(solicitud);
            if (resolucion == null) {
